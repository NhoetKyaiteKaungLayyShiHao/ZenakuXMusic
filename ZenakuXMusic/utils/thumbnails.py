...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("ZenakuXMusic/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('ZenakuXMusic/assets/font.ttf', 30)
            font2 = ImageFont.truetype('ZenakuXMusic/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('ZenakuXMusic/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('ZenakuXMusic/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "「ꜱᴀꜱᴜᴋᴇ ✘ ᴍᴜꜱɪᴄ 」", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "NOW PLAYING", fill="red", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
